...
export const AddUser = (props) => {
    ...
    const { user, error,success ,message } = useSelector((state) => state.createuser);
            ...
            <div className="kundli pb-5 mt-5">
                <div className="container">
                    <div className="row main">
                        ...
                        <div className="col-md-8">
                            <h3 className="mb-3 shadow text-success">ADD USER</h3>
                            <form className="shadow" method="post" onSubmit={adduserForm} style={{ padding: '55px', borderRadius: '20px' }}>
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        <button type="submit" className="btn btn-md btn-primary form-control">ADD NEW USER</button>
                                    </div>
                                </div>
                            </form>
                        </div>
